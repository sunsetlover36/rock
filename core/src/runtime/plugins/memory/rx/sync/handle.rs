...
use crate::{
    ...
    rx::sync::{
        PolicyHandle, add_base_handle_methods, routing::add_routing_rx_handle_methods,
        spatial::add_area_rx_handle_methods,
    },
};

pub(in crate::runtime::plugins::memory) struct SyncRxHandle {
    id: PolicyId,
}
impl SyncRxHandle {
